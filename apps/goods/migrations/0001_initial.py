# Generated by Django 2.0.7 on 2018-09-11 14:22
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('goods_front_image_url', models.ImageField(default='', max_length=300, upload_to='', verbose_name='封面图')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.CharField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '三级类目')], help_text='类别级目', max_length=200, verbose_name='类别级目')),
                ('is_tab', models.BooleanField(default=False, help_text='是否导航', verbose_name='是否导航')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
                ('parent_category', models.ForeignKey(blank=True, help_text='父类级目', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sub_cat', to='goods.GoodsCategory', verbose_name='父类级目')),
            ],
            options={
                'verbose_name': '商品类别',
